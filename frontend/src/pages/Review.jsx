  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
      <section className="space-y-6">
        ...
        {reviewState.actionMessage ? (
          <section className="glass-panel rounded-[24px] border border-emerald-300/20 bg-emerald-500/10 px-5 py-4 text-sm text-emerald-100">
            {reviewState.actionMessage}
          </section>
        ) : null}
        ...
        {reviewState.isProcessing ? (
          ...
          >
            <Dashboard isStreaming={reviewState.isStreaming} review={reviewState.review} summary={reviewState.streamedSummary} />
          </motion.div>
        )}
      </section>
